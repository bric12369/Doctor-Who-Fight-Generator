const goodiesList = ['The Doctor', 'Rose Tyler', 'Donna Noble', 'Mickey Smith', 'Sarah Jane Smith',
    ...
    'Captain Jack Harkness', 'Jackie Tyler', 'Kate Stewart', 'Clara Oswald'];

const baddiesList = ['a Dalek', 'a Cyberman', 'a Sontaran', 'The Master', 'Zygons',
    'Vashta Narada', 'a Weeping Angel', 'The Silence', 'The Family of Blood', 'The Midnight Creature'
    'The Beast', 'The Abzorbaloff', 'The Adipose', 'Lady Cassandra', 'Maestro',
...
const locationsList = ['Earth', 'The Powell Estate', 'Gallifrey', 'Clom',
    ...
    'The Library', 'Midnight', 'Sontar', 'Trenzalore', '']